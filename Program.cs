...
Banda bandaLinkinPark = new Banda("Linkin Park");
bandaLinkinPark.AdicionarNota(new Avaliacao(10));
bandaLinkinPark.AdicionarNota(new Avaliacao(5));
Banda bandaBeatles = new Banda("The Beatles");
bandaBeatles.AdicionarNota(new Avaliacao(10));
bandaBeatles.AdicionarNota(new Avaliacao(9));
bandaBeatles.AdicionarNota(new Avaliacao(5));


Dictionary<string, Banda> bandasRegistradas = new();
bandasRegistradas.Add(bandaLinkinPark.Nome, bandaLinkinPark);
bandasRegistradas.Add(bandaBeatles.Nome, bandaBeatles);
